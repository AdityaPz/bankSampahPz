...
class ProfileNasabah extends StatefulWidget {
  const ProfileNasabah({super.key});

  @override
  State<ProfileNasabah> createState() => _ProfileNasabahState();
}

class _ProfileNasabahState extends State<ProfileNasabah> {
  @override
          ...
          child: Center(
            child: Column(
              children: [
                ...
                fieldText(size, 'Kode Nasabah', 'KP-1102231', false),
