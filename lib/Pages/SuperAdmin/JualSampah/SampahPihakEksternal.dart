...
import 'package:bank_sampahad/Pages/SuperAdmin/JualSampah/PenjualanSampahPihakEksternal.dart';
...
class SampahPihakEksternalScreen extends StatefulWidget {
  const SampahPihakEksternalScreen({super.key});

  @override
  State<SampahPihakEksternalScreen> createState() =>
      _SampahPihakEksternalScreenState();
}

class _SampahPihakEksternalScreenState
    extends State<SampahPihakEksternalScreen> {
  String query = "";
                            ...
                            child: TextButton(
                              ...
                              onPressed: () async {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (builde) {
                                      return PenjualanSampahPihakEksternalScreen();
                                    },
                                  ),
                                ).then((value) {
                                  setState(() {});
