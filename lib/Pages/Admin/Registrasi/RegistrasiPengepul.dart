...
class RegistrasiPengepul extends StatefulWidget {
  const RegistrasiPengepul({Key? key}) : super(key: key);

  @override
  State<RegistrasiPengepul> createState() => _RegistrasiPengepulState();
}

class _RegistrasiPengepulState extends State<RegistrasiPengepul> {
  @override
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            fieldText1(
                                size, 'Kode Pengepul', 'Kode Pengepul', true),
                            fieldText1(
                                size, 'Nama Pengepul', 'Nama Pengepul', true),
